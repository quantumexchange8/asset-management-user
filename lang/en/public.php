...
return [
    ...
    "receive_on_saturday" => "Receive On",
    "link_account" => "Link Account",
    "account_information" => "Account Information",
    "proof_of_account" => "Proof Of Account",
    "toast_link_request_success" => "Successfully sent request on linking account",
    "warning" => "Warning",
    "toast_account_pending_warning" => "Please wait for admin to verify your account",
    "toast_account_already_linked_warning" => "Account already linked successfully",
    "linked" => "Linked",
    "unlink" => "Unlink",
    ...
    "missing_payment_account_caption" => "You don't have any payment account. Proceed to Profile to add one.",
    "proceed" => "Proceed",
    "finance" => "Finance",
    ...
    "bank_placeholder" => "Select Bantok",
